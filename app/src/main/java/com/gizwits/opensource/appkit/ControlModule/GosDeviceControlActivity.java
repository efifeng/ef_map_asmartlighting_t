...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_delete;
	private TextView tv_data_R;
	private SeekBar sb_data_R;
	private TextView tv_data_G;
	private SeekBar sb_data_G;
	private TextView tv_data_B;
	private SeekBar sb_data_B;
	private TextView tv_data_level;
	private SeekBar sb_data_level;
	...
	private void initView() {
		...
		sw_bool_delete = (Switch) findViewById(R.id.sw_bool_delete);
		tv_data_R = (TextView) findViewById(R.id.tv_data_R);
		sb_data_R = (SeekBar) findViewById(R.id.sb_data_R);
		tv_data_G = (TextView) findViewById(R.id.tv_data_G);
		sb_data_G = (SeekBar) findViewById(R.id.sb_data_G);
		tv_data_B = (TextView) findViewById(R.id.tv_data_B);
		sb_data_B = (SeekBar) findViewById(R.id.sb_data_B);
		tv_data_level = (TextView) findViewById(R.id.tv_data_level);
		sb_data_level = (SeekBar) findViewById(R.id.sb_data_level);
	...
	private void initEvent() {
		...
		sw_bool_delete.setOnClickListener(this);
		sb_data_R.setOnSeekBarChangeListener(this);
		sb_data_G.setOnSeekBarChangeListener(this);
		sb_data_B.setOnSeekBarChangeListener(this);
		sb_data_level.setOnSeekBarChangeListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.sw_bool_OnOff:
			...
			break;
		case R.id.sw_bool_delete:
			sendCommand(KEY_DELETE, sw_bool_delete.isChecked());
			break;
		default:
			break;
		}
	...
	public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
		...
		case R.id.sb_data_R:
			tv_data_R.setText(formatValue((progress + R_OFFSET) * R_RATIO + R_ADDITION, 1));
			break;
		case R.id.sb_data_G:
			tv_data_G.setText(formatValue((progress + G_OFFSET) * G_RATIO + G_ADDITION, 1));
			break;
		case R.id.sb_data_B:
			tv_data_B.setText(formatValue((progress + B_OFFSET) * B_RATIO + B_ADDITION, 1));
			break;
		case R.id.sb_data_level:
			tv_data_level.setText(formatValue((progress + LEVEL_OFFSET) * LEVEL_RATIO + LEVEL_ADDITION, 1));
			break;
		case R.id.sb_data_temp:
			tv_data_temp.setText(formatValue((progress + TEMP_OFFSET) * TEMP_RATIO + TEMP_ADDITION, 1));
			break;
		default:
			break;
		}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		switch (seekBar.getId()) {
		case R.id.sb_data_R:
			sendCommand(KEY_R, (seekBar.getProgress() + R_OFFSET ) * R_RATIO + R_ADDITION);
			break;
		case R.id.sb_data_G:
			sendCommand(KEY_G, (seekBar.getProgress() + G_OFFSET ) * G_RATIO + G_ADDITION);
			break;
		case R.id.sb_data_B:
			sendCommand(KEY_B, (seekBar.getProgress() + B_OFFSET ) * B_RATIO + B_ADDITION);
			break;
		case R.id.sb_data_level:
			sendCommand(KEY_LEVEL, (seekBar.getProgress() + LEVEL_OFFSET ) * LEVEL_RATIO + LEVEL_ADDITION);
			break;
		case R.id.sb_data_temp:
	...
	protected void updateUI() {
		...
		sw_bool_delete.setChecked(data_delete);
		tv_data_R.setText(data_R+"");
		sb_data_R.setProgress((int)((data_R - R_ADDITION) / R_RATIO - R_OFFSET));
		tv_data_G.setText(data_G+"");
		sb_data_G.setProgress((int)((data_G - G_ADDITION) / G_RATIO - G_OFFSET));
		tv_data_B.setText(data_B+"");
		sb_data_B.setProgress((int)((data_B - B_ADDITION) / B_RATIO - B_OFFSET));
		tv_data_level.setText(data_level+"");
		sb_data_level.setProgress((int)((data_level - LEVEL_ADDITION) / LEVEL_RATIO - LEVEL_OFFSET));
